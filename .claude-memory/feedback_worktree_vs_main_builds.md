...
- dgPOS (Maven, JavaFX 23.0.1) also needs JDK 25. Default PATH `java` is 17 and fails with "invalid target release: 25" + JavaFX class-version 65.0 errors. Run Maven with `JAVA_HOME="C:/Program Files/Java/jdk-25" PATH="C:/Program Files/Java/jdk-25/bin:$PATH" mvn -q -DskipTests compile`.
